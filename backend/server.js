...
const authentication = require('./authentication');  // <-- Importing the authentication module
...
// Add the authentication middleware <-- This is the new middleware for authentication
